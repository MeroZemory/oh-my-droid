...
PLUGIN_DIR="$HOME/.factory/plugins/cache/omc/oh-my-droid"
if [ -d "$PLUGIN_DIR" ]; then
  ...
  echo "Plugin not installed - install with: claude /install-plugin oh-my-droid"
fi
```
...
```bash
gh api -X PUT /user/starred/Yeachan-Heo/oh-my-droid 2>/dev/null && echo "Thanks for starring! ⭐" || echo "Could not star - you can star manually at https://github.com/Yeachan-Heo/oh-my-droid"
```
