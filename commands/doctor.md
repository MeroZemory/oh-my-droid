...
INSTALLED=$(ls ~/.factory/plugins/cache/omc/oh-my-droid/ 2>/dev/null | sort -V | tail -1)
...
ls ~/.factory/plugins/cache/omc/oh-my-droid/ 2>/dev/null | wc -l
```
...
cd ~/.factory/plugins/cache/omc/oh-my-droid/
...
```
WebFetch(url: "https://raw.githubusercontent.com/Yeachan-Heo/oh-my-droid/main/docs/FACTORY.md", prompt: "Return the complete raw markdown content exactly as-is")
```
