...
When you place rules in `.claude/rules/`, they are automatically discovered by oh-my-droid and injected into the context for all agents working in your project.
