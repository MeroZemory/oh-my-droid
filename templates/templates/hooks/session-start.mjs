...
async function checkForUpdates(currentVersion) {
  const cacheFile = join(homedir(), '.omd', 'update-check.json');
  const now = Date.now();
  ...
  try {
    ...
    const response = await fetch('https://registry.npmjs.org/oh-my-droid/latest', {
...
To update, run: claude /install-plugin oh-my-droid
