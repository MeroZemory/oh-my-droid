/**
 * Hooks Module for Oh-My-Claude-Droid
 *
 * This module provides the TypeScript bridge for Factory Droid's native shell hook system.
 * Shell scripts call these TypeScript functions for complex logic processing.
 *
 * Architecture:
 * - Factory Droid runs shell scripts on hook events (UserPromptSubmit, Stop, etc.)
 * - Shell scripts invoke Node.js bridge for complex processing
 * - Bridge returns JSON response that shell passes back to Factory Droid
 */
...
} from './omd-orchestrator/index.js';
