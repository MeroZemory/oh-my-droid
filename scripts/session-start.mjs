...
/**
 * Droid Session Start Hook (Node.js)
...
function checkHudInstallation() {
  const hudScript = join(homedir(), '.claude', 'hud', 'omd-hud.mjs');
...
[Droid] HUD not configured (${hudCheck.reason}). Run /hud setup then restart Factory Droid.
</system-reminder>`);
    }
